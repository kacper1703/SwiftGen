...
* As Swift 3 is officially no longer maintained, we're obsoleting the Swift 3 templates and they are no longer included with SwiftGen. You can still get the old swift 3 templates from older SwiftGen versions, or from GitHub by browsing older tags.  
